...
static void	free_editor_interface_sub4(t_editor_interface *editor_interface)
{
	...
	// libui_widget_destroy(&editor_interface->up_button_physics_drag_x);
	// libui_widget_destroy(&editor_interface->down_button_physics_drag_x);
	// libui_widget_destroy(&editor_interface->up_button_physics_drag_y);
	// libui_widget_destroy(&editor_interface->down_button_physics_drag_y);
	// libui_widget_destroy(&editor_interface->up_button_physics_drag_z);
	// libui_widget_destroy(&editor_interface->down_button_physics_drag_z);
	// libui_widget_destroy(&editor_interface->up_button_physics_gbl_fric_x);
	// libui_widget_destroy(&editor_interface->down_button_physics_gbl_fric_x);
	// libui_widget_destroy(&editor_interface->up_button_physics_gbl_fric_y);
	// libui_widget_destroy(&editor_interface->down_button_physics_gbl_fric_y);
	// libui_widget_destroy(&editor_interface->up_button_physics_gbl_fric_z);
	// libui_widget_destroy(&editor_interface->down_button_physics_gbl_fric_z);
	libui_widget_destroy(&editor_interface->up_button_physics_gravity_x);
	//libui_widget_destroy(&editor_interface->down_button_physics_gravity_x);
	 libui_widget_destroy(&editor_interface->up_button_physics_gravity_y);
	// libui_widget_destroy(&editor_interface->down_button_physics_gravity_y);
	 libui_widget_destroy(&editor_interface->up_button_physics_gravity_z);
	// libui_widget_destroy(&editor_interface->down_button_physics_gravity_z);
}
