...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/03 17:40:52 by hmartzol          #+#    #+#             */
/*   Updated: 2019/09/03 17:40:58 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <bmml_functions.h>

static inline void	i_sub(t_data_ptr ptr, t_ptr_type type, t_data val1,
	t_data val2)
{
	if (type == PT_I8)
