...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/03 17:40:37 by hmartzol          #+#    #+#             */
/*   Updated: 2019/09/03 17:40:38 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <bmml_functions.h>

static inline void	i_mul(t_data_ptr ptr, t_ptr_type type, t_data val1,
	t_data val2)
{
	if (type == PT_I8)
