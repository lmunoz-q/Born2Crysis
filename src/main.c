...
/*   Updated: 2019/08/19 20:29:22 by mfischer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// >>>>>>> dev
	...
	t_obj *tmp3;
	tmp3 = load_obj("assets/objects/crate.obj");
	e->editor.item_placer = obj_to_mesh(tmp3, "assets/redbrick.bmp", TX_CLAMP_EDGES);
	printf("%p\n", tmp3);
