...
/*   Updated: 2019/07/23 01:06:09 by mfischer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_test_world(t_e *e)
{
	...
	tmp = load_obj("assets/objects/tank.obj");
	...
	mf_memcpy(&e->world.sectors->objects[0], obj_to_object(tmp, "assets/lava.bmp", TX_REPEAT), sizeof(t_object));
	mf_memcpy(&e->world.sectors->objects[1], obj_to_object(tmp, "assets/lava.bmp",  TX_REPEAT), sizeof(t_object));
	mf_memcpy(&e->world.sectors->objects[2], obj_to_object(tmp, "assets/lava.bmp",  TX_REPEAT), sizeof(t_object));
	
	mat4_scale(e->world.sectors->objects[0].mesh->matrix, 10, 10, 10);
	mat4_translate(e->world.sectors->objects[0].mesh->matrix, -100, 0, 0);
	mat4_rotate_yaw(e->world.sectors->objects[0].mesh->matrix, -90);
	mat4_scale(e->world.sectors->objects[1].mesh->matrix, 10, 10, 10);
	mat4_translate(e->world.sectors->objects[1].mesh->matrix, 80, 0, 0);
	mat4_rotate_yaw(e->world.sectors->objects[1].mesh->matrix, -90);
	mat4_scale(e->world.sectors->objects[2].mesh->matrix, 10, 10, 10);
