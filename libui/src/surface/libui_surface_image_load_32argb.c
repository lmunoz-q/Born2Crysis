...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   libui_surface_image_load_32argb.c                  :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tfernand <tfernand@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/22 16:31:11 by tfernand          #+#    #+#             */
/*   Updated: 2019/08/22 16:31:32 by tfernand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	int width, int height)
{
	...
	if ((out = SDL_CreateRGBSurface(SDL_SWSURFACE, width, height, 32, 0xFF0000,
