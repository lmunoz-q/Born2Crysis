...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   libui_create_button.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tfernand <tfernand@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/22 16:49:46 by tfernand          #+#    #+#             */
/*   Updated: 2019/08/22 16:49:46 by tfernand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libui.h"

int	libui_create_button(t_libui_widget *widget, SDL_Rect rect, int color)
{
	SDL_Rect	rect_tmp;
	SDL_Point	pos;

	*widget = libui_widgets_templates_null();
	widget->type = LUI_WT_BUTTON;
	widget->rect = rect;
	pos.x = rect.x;
	pos.y = rect.y;
